...
import { BadgeCheck, LayoutDashboard, LogOut, Puzzle, Settings, Shield, Wallet, IndianRupee, GraduationCap, Menu, X, Trophy, ClipboardCheck, PackageCheck, Table as TableIcon, CalendarDays, Award } from "lucide-react";
...
const links = [
  ...
  { to: "/admin/evaluation", label: "Mentor & Jury Score Sheets", icon: Award },
  ...
  { to: "/admin/final-teams", label: "All Confirmed Teams", icon: Shield },
  { to: "/admin/final-round", label: "Final Round 25 Teams", icon: Trophy },
